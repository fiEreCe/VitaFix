// Vercel serverless proxy for multipart resume uploads.
...
module.exports = async function proxyResumeUpload(req, res) {
  try {
    ...
    console.error('resume upload proxy error:', error.message)
    res.status(502).json({
