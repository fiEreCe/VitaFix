...
const atomic = [
  ...
  item('A-021', '无关商业主张不得复用访谈事实', 'blocked', { text: '牵头制定公司战略并推动营收增长', factRefs: ['f1'] }, [fact()]),
  item('A-022', '用户数量不得复用为营收百分比', 'blocked', { text: '实现营收增长20%', factRefs: ['f1'] }, [fact({ sourceText: '访谈20位用户', quantity: '20位用户' })]),
  item('A-023', '连续无效回答停止循环', 'unavailable', { text: '', factRefs: [] }, [fact()]),
  item('A-024', '参与调研不得扩大为商业化体系', 'blocked', { text: '建立商业化增长体系', factRefs: ['f1'] }, [fact({ sourceText: '参与调研', action: '参与调研' })]),
